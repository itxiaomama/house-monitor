define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'upload', 'base64', 'template', 'bootstrap-daterangepicker'], function ($, undefined, Backend, Table, Form, Upload, Template) {
    var Controller = {
        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    edit_url: 'engineering/data/edit?item_id='+ item_id,
        ...
        daily: function () {
            ...
            $(document).on('click', '.layer-down', function () {
                ...
                if (data_time == '') {
                    ...
                    var url = 'engineering/data/down_daily/?id=' + item_id + '&date=' + data_time ;
        ...
        chart: function () {
            ...
            // function get_time_list(start, end) {
            //     if (point_id) {
            //         var where = { 'item_id': item_id, 'start': start, 'end': end, 'point_id': point_id };
            //         $.ajax({
            //             type: "POST",
            //             url: 'engineering/data/get_time_list',
            //             data: where,
            //             dataType: 'json',
            //             success: function (re) {
            //                 var str = '';
