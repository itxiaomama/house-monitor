define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    var Controller = {
        add: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'engineering/alarm_notice/get_staffs' + location.search,
                    table: 'staff',
                }
            });
            var table = $("#table");
            ...
            $(document).on('click', '.btn-success', function () {
                ...
                if(ids){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "engineering/alarm_notice/add",
                        data: {'engineering_id': engineering_id,'ids': ids, 'type': type},
                        dataType: 'json',
                        error:function (re){
                        ...
                        success: function (re){
                            ...
                            if(re.code == 1){
                                ...
                                parent.$("#alarmtab"+type).bootstrapTable('refresh');
                            }else{
