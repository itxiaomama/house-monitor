define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'device/video/index' + location.search,
                    add_url: 'device/video/add',
                    edit_url: 'device/video/edit',
                    del_url: 'device/video/del',
                    multi_url: 'device/video/multi',
                    import_url: 'device/video/import',
                    table: 'video',
                }
            });
