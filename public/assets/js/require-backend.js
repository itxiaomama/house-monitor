require.config({
    urlArgs: "rv=" + requirejs.s.contexts._.config.config.site.version,
    packages: [{
        name: 'moment',
...
require(['jquery', 'bootstrap'], function ($, undefined) {
    ...
    // 配置语言包的路径
    var paths = {};
    paths['lang'] = Config.moduleurl + '/ajax/lang?callback=define&controllername=' + Config.controllername + '&lang=' + Config.language + '&rv=' + Config.site.version;
    // 避免目录冲突
